          ...
          {client.applications.map(app => (
            <div key={app.id} className="flex items-center gap-3 bg-white/[0.03] border border-white/8 rounded-xl px-4 py-3">
              <div className="flex-1 min-w-0">
                ...
                <a
                  href={`https://www.google.com/search?q=${encodeURIComponent(`site:linkedin.com/in "${app.company}" ("talent acquisition" OR "recruiter" OR "HR manager" OR "hiring manager")`)}`}
                  target="_blank"
